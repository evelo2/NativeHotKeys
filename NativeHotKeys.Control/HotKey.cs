...
// This code is taken from : http://tom-shelton.net/
// Modifications - 
// 1/. Allow Modifier to be Modifiers.None (as we wanted to use ~ as a hot key)
// 2/. Added convenience method UnregisterHotKey()
// 3/. Some tweaks for modern .NET now available.
...
namespace NativeHotKeys.Controls
{
    ...
    public partial class HotKey : Component
    {
        ...
        /// <summary>
        /// This is just a convenience method to remove the HotKey. 
        ...
        {
            HotKeyPressed?.Invoke( this, new EventArgs () );
        }
        ...
        private class HotKeyNativeWindow : NativeWindow
        {
            ...
            public void RegisterHotkey ()
            {
                if ( this.HandleCreated () && Owner.Key != Keys.None )
                {
                    if ( this.HotKeyID == 0 )
